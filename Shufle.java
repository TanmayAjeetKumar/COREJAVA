...
class ValidShuffle
{
	...
	public static void main(String[] args)
	{
		...
		if (isInterleaving(X, Y, Z)) {
			System.out.print("true : third string is valid shufle of first and second string");
		}
		else {
			System.out.print("false : third string is NOT a valid shufle of first and second string");
		}
	}
}